const CONFIG = {
    ...
    categories: [
        ...
        {
            title: "<img src='https://raw.githubusercontent.com/HIDDIFYplas/Hiddify_plas/main/Android.png' style='width:56px;height:48px;vertical-align:-12px;margin-right:10px;'>Android",
